'''
Docstring for Chapter 11.Labs.11.12 LAB Unique random numbers(random module)
...
def unique_random_ints(how_many, max_num):
    ...
    while len(result_list) < how_many:
...
if __name__ == '__main__':
    ...
    random.seed(seed)
    result = unique_random_ints(how_many, max_num)
