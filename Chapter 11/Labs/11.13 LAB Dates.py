'''
Docstring for Chapter 11.Labs.11.13 LAB Dates
...
# Output sorted dates in mm/dd/yyyy format
for d in sorted_dates:
    print(d.strftime("%m/%d/%Y"))

# Days between last two dates
difference = sorted_dates[-1] - sorted_dates[-2]
print(difference.days)

# Date 3 weeks from most recent
three_weeks = timedelta(weeks=3)
future_date = sorted_dates[-1] + three_weeks
