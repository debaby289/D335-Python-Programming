'''
Docstring for Chapter 4.Labs.4.13 LAB List basics
...
# 1. TODO: Define my_list containing my_flower1, my_flower2, and my_flower3 in that order
my_list = [my_flower1, my_flower2, my_flower3]

# 2. TODO: Define your_list containing your_flower1 and your_flower2 in that order
