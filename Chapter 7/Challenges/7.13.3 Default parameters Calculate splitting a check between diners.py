'''
Docstring for Chapter 7.Challenges.7.13.3 Default parameters Calculate splitting a check between diners
...
def split_check(bill,people,tax_percentage = 0.09,tip_percentage = 0.15):
    total_amount = (bill + (tip_percentage * bill) + (tax_percentage * bill)) / people
    return total_amount
